...
const zhCN = {
  ...
  "export.format": "格式",
  "export.size": "大小",
  "export.failedCheckTheEventLog": "失败，请查看事件日志",
  ...
  "progress.subtitleTranslationProgress": "字幕翻译进度",
  "progress.currentStatus": "当前状态",
  "progress.loading": "加载中",
  "progress.currentStage": "当前步骤",
  "progress.waitingForProgress": "等待后台进度",
  ...
  "progress.reassembleInTheDefaultFormat": "重新组装默认格式",
  ...
  "progress.inputOutputTokens": "输入 / 输出 Token",
  "progress.modelCalls": "模型调用次数",
  ...
  "workflowPanel.polishingRunsWithTranslationBatchesTheseCards":
    "润色随翻译批次执行；以上卡片表示流程配置，完成情况以任务状态及最近步骤为准。导出任务在导出页单独查看。",
  ...
  "review.noIssuesRecordedInThisReview": "本次审校没有已记录的问题",
  "review.noIssuesRecordedYetTheRunMay": "暂无问题记录；运行可能尚未完成",
