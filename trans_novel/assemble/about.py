...
ABOUT_TITLE = "关于此翻译"
ABOUT_TITLE_EN = "About This Translation"
...
def about_xhtml(lang: str) -> bytes:
    ...
    if (lang or "").lower().startswith("en"):
        ...
        lead = "This book was generated by the <strong>Wenyi</strong> project."
        description = (
            "Wenyi is an open-source command-line tool for long-form literary translation. "
            "It supports multilingual fiction translated into Chinese and Chinese fiction "
            "translated into English, with whole-book analysis, rolling context, a live "
            "glossary, polishing, and review stages designed to improve accuracy, continuity, "
            "and readability."
        )
        feedback = (
            "The project is still evolving. If you notice inconsistent names, terminology, "
            "character voices, or other translation issues, feedback is welcome:"
        )
        repository_label = "GitHub repository:"
        repository_help = (
            "Open an issue or start a discussion<br/>"
            "Pull requests are welcome<br/>"
            "Project QQ group: 1055065098"
        )
        closing = (
            "Wenyi is developed as a personal open-source project for making long-form works "
            "available across languages. Every report and suggestion helps improve it. Thank "
            "you for reading."
        )
    else:
        title = ABOUT_TITLE
        lead = "本书由 <strong>文译（Wenyi）</strong> 项目生成。"
        description = (
            "文译是一个面向长篇文学翻译的开源命令行工具，支持将多语言小说翻译为中文，"
            "以及将中文小说翻译为英文。它提供全书预扫、滚动上下文、实时术语库、润色和审校"
            "等功能，力求在准确的前提下让译文从可读向好读迈进。"
        )
        feedback = (
            "项目目前仍在初期阶段，翻译质量尚有提升空间。如果您发现译文中的问题（如专有名词"
            "翻译不一致、口头禅前后不统一等），或对翻译质量有任何建议，欢迎通过以下方式反馈："
        )
        repository_label = "GitHub 仓库："
        repository_help = (
        ...
        closing = (
            "本项目为个人兴趣所开发，仅在于针对长文本书籍的译介做出一份微薄的努力。"
            "每一份反馈和建议，都会让这个工具变得更好。感谢您的阅读。"
        )
...
<body>
  <section class="tn-about">
    <h1>{title}</h1>
    <p class="tn-about-lead">{lead}</p>
    <p>{description}</p>
    <p>{feedback}</p>
    <div class="tn-about-feedback">
      <p><strong>{repository_label}</strong>
        <a href="{ABOUT_REPOSITORY}">github.com/BigDawnGhost/wenyi</a><br/>
        {repository_help}
      </p>
    </div>
    <p class="tn-about-closing">{closing}</p>
  </section>
</body>
</html>
""".encode()
