...
Config/LLMClient/agents, language restoration, events, usage checkpoints, metrics, timing,
snapshots and source validation.
...
language contains pure language helpers; runstore persists state; context manages recent
translations; metrics records runs; checks validates results. Review evidence lives in
